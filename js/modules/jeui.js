...
;!function(win){ 
    ...
    var extend = function(){
        var arr = arguments, result = {}, i, _extend, _isObject;
        _isObject = function(o){
            return Object.prototype.toString.call(o) === '[object Object]';
        };
        _extend = function self(dest, source) {
            var property;
            for (property in dest) {
                if (dest.hasOwnProperty(property)) {
                    // 若dest[property]和sourc[property]都是对象，则递归
                    if (_isObject(dest[property]) && _isObject(source[property])) {
                        self(dest[property], source[property]);
                    };
        ...
        for (i = arr.length - 1; i >= 0; i--) {
            if (_isObject(arr[i])) _extend(arr[i], result);
        }
        arr[0] = result;
        return result;
    };
